      ...
      echo 'Scanning'
        ...
        withSonarQubeEnv(installationName:'SonarQube') {
            script {
              ...
              sh "/var/lib/jenkins/sonar-scanner/sonar-scanner-3.3.0.1492-linux/bin/sonar-scanner -Dsonar.host.url=http://localhost:9000 -Dsonar.projectName=meanstackapp -Dsonar.projectVersion=1.0 -Dsonar.projectKey=meanstack:app -Dsonar.sources=. -Dsonar.projectBaseDir=/var/lib/jenkins/workspace/HHA_develop"
